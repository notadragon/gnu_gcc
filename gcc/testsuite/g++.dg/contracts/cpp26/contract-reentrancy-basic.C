...
// Clang asserted on almost every shape below, because its on-odr-use contract
// instantiation borrowed the enclosing function's scope, which was already
// marked as being in a contract.  GCC
