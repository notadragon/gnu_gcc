...
//
// The dialect floor is C++20, matching the contracts entries in version.def:
// -fcontracts-p3290 is honoured below C++26, and what sets the floor is
// <source_location> below, not the standard the paper targets.
...
#endif // C++20 && __gcc_contracts_p3290
