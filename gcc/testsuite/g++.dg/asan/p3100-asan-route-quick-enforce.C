// P3100: with -fcontracts-p3100 but WITHOUT -fcontracts-p4298,
...
// handler at all).  The sanitizer emits NOTHING on the routed path,
...
// quick_enforce is a SILENT fast terminate.  The sanitizer prints nothing
