...
// the captured value.  A late-parse path that stores the message without
// normalizing it to a bare STRING_CST ICEs here -- "expected string_cst,
// have view_convert_expr in build_contract_data_block_ctor".
