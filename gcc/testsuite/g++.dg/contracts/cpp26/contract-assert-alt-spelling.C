...
// recognized there and triggered an internal compiler error (GCC-29).
// Fixed upstream by 3bd34f8936c, landed 2026-09-20, so stock g++ trunk no
// longer reproduces it.  This test stays as coverage: it needs -fcontracts
// and so could not travel with that patch.
...
// The ICE is an unhandled case at the bottom of grok_contract, so anything
// that arrives there by another route is worth pinning.
