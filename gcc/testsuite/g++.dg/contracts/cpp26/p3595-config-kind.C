// P3595 x config: "kind" matching selects semantics per contract kind.  This
// is the kind:"post" and kind:"assert" half; kind:"pre" is covered
// elsewhere.  The config sends post and assert to ignore and lets pre fall
