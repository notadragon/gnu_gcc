...
// called") and dispatches it through a libcontracts helper, which owns the
// data-block/descriptor construction used from this file -- no data block is
// hand-rolled here.
//
// It is NOT the only such construction in the tree: src/c++26/contract26.cc
// declares its own __p3290_data_block_t and __p3290_desc_t, structurally
// identical to libcontracts' c_p3290_data_block_t and c_p3290_desc_t and
// maintained separately.  Sharing them would mean libstdc++ including a
// libcontracts header, so the duplication stands.
//
// The throwing enforce/observe termini need no C++
