...
// building the expression, so left unchecked they leak into the noexcept
// operator's tree walk and make noexcept(<guarded expr>) false for every
// checking semantic.  Guard emission is therefore suppressed in an unevaluated
