...
subject: 'c++: contracts: P4283: parse the label and the requires-clause of a contract assertion'
depends:
...
- gcc/cp/parser.cc : @cp_function_contract_specifier_intro, /Parse optional assertion-control-specifier/, /Skip optional assertion-control-specifier/, /^static size_t cp_skip_contract_requires_clause$/, /^cp_skip_balanced_group \(cp_parser \*parser, size_t n\)$/, @cp_nth_token_is_contract_intro_p, /^cp_skip_contract_requires_clause \(cp_parser \*parser, size_t n,$/, /^done:$/, /Replay a deferred requires-clause \(P4283\) first/
