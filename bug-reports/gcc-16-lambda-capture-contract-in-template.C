...
// (added by gnu_gcc commit 1f764681499), with DejaGnu directives stripped.
// Requires -fcontracts -fcontract-evaluation-semantic=observe and a hosted
// <contracts> header (C++26).
