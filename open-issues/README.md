...
| GCC-36 | The postcondition const-parameter rule is reported twice for a function template, by the redeclaration carry-over and by the predicate walk | defect | None found (searched 2026-09-06) | [../bug-reports/gcc-36-postcondition-const-rule-over-reported.md](../bug-reports/gcc-36-postcondition-const-rule-over-reported.md) |
