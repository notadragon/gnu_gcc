...
| GCC-36 | A non-template's postcondition const-parameter diagnostic is emitted twice, byte-identical at the same location | Open | None found (searched 2026-09-06) | [gcc-36-postcondition-const-rule-over-reported.md](gcc-36-postcondition-const-rule-over-reported.md) |
