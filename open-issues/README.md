...
| GCC-48 | The C front end accepts a contract in a typedef declaration silently, and only warns on a function-typed parameter -- the C++ half of this family was fixed on 2026-09-16 | deferred | -- | [gcc-48/gcc-48-c-contract-on-non-function-declarator.md](gcc-48/gcc-48-c-contract-on-non-function-declarator.md) |