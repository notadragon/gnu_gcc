...
// against, which was Clang's and never GCC's.
//
...
//
// This is the case that exposes substituting a function's contracts only
// when a definition is instantiated: for a pure virtual that never happens,
// so the P3097 wrapper meets a still-dependent predicate and ICEs.  That
// failure has nothing to do with re-entrancy; see
