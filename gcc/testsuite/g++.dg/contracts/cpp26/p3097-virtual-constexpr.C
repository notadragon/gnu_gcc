...
//
// The wrapper inherits the callee's constexpr-ness, and has to: a synthesized
// contract wrapper that is not constexpr leaves a constexpr virtual function
// carrying a contract unable to be constant-evaluated ("call to
// non-'constexpr' function '...contract_wrapper()'").
