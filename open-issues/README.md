...
| GCC-27 | A friend declaration that redeclares an ordinary namespace-scope function has its contract checked against neither the earlier declaration nor anything else | deferred | [PR127291](https://gcc.gnu.org/bugzilla/show_bug.cgi?id=127291) * | [../bug-reports/gcc-27/gcc-27-deferred-friend-contract-mismatch.md](../bug-reports/gcc-27/gcc-27-deferred-friend-contract-mismatch.md) |
