...
// and reaches the handler.  A late-parse path that stores the raw message
// without the normalization grok_contract applies to non-deferred contracts
// ICEs here ("expected string_cst, have var_decl in
// build_contract_data_block_ctor"); p3097-capture-message.C is the sibling
// shape.  Complements p3099-message-cexpr-str.C (free function) and
