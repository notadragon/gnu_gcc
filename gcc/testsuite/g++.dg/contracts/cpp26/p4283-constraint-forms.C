...
// substituted constraint must be normalized before satisfaction: handed
// straight to it, a conjunction, disjunction, negation, or lone atomic
// constraint ICEs in satisfy_nondeclaration_constraints.
// Verify that each form compiles and selects/discards the contract
