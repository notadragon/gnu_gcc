...
// is being applied.
//
// Tracked as GCC-17 in this repository's bug-reports/; Clang has it too.
// This file exists so that the day the remaining row
// starts being diagnosed, its xfail becomes an XPASS and we are told.
//
// The two compilers do NOT agree, which is why the
