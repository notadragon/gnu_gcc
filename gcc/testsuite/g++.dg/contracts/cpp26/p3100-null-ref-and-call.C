...
//
// Regression test: every null/alignment gate needs the "or a contract routes
// this" treatment, including
// ubsan_maybe_instrument_reference_or_call.  Hard-coding
// IMPLICIT_UB_NONE into its reaction operands is the easy miss: that function
...
// p->m get their trap guard while those two get no instrumentation at all
