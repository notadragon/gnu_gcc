...
// Regression test: this ICEs in expand_expr_real_1 if the
// wrapper and original function share capture VAR_DECLs, because
// destructive DECL_INITIAL clearing in the first-processed function
// leaves the second with uninitialized captures.
