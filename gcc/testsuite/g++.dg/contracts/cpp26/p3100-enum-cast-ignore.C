// P3100: enum-cast out of range configured to "ignore": no handler; the
// erroneous conversion yields the defined substituted value 0.
// { dg-do run { target c++26 } }
// { dg-additional-options "-fcontracts -fcontracts-p3100" }
// { dg-additional-options "-fcontract-configuration-file=${srcdir}/g++.dg/contracts/cpp26/p3100-enum-cast-ignore.json" }
