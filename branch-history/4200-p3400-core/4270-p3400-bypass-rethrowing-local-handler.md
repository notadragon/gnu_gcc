...
- gcc/cp/contracts.cc : @RETHROW_MAX_DEPTH, @accessor_value, @aval, @aval_kind, @calls_std_fn_p, @contract_local_handler_always_rethrows_p:0, #200:1, @namespace, @private, @public, @rethrow_analysis, @rethrow_outcome, @strip_to_decl
