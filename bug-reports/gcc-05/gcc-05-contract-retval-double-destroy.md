...
**Status:** Fixed here (commit [37905cb14302](https://github.com/notadragon/gnu_gcc/commit/37905cb143028d020144cb60c21e0d2a0eececb4))
**Resolved by:** `1140-retval-destroyed-on-unwind`, which also fixes
GCC-44: both defects come from the contracts block being seen as a second
function body, and one deferred cleanup answers both.
