// P3100 (UBSan runtime routing) under LTO: the routing descriptor is a
...
// Highest-risk path: a non-recover LTRANS codegen would re-fault on the continue.

// { dg-do run }
// { dg-additional-options "-std=c++26 -fcontracts-p3100 -fcontracts-p4298 -fsanitize=alignment -fsanitize-semantic=alignment:noexcept_observe -flto -fno-fat-lto-objects" }
