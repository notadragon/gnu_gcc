...
// the result is evaluated during translation.  Attempting that evaluation with
// diagnostics suppressed leaves the facet quietly doing nothing instead --
// the label looks applied, and the comment or semantic is simply unchanged.
//
