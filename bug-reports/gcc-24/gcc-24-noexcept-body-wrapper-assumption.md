...
**Status:** Fixed here (commit [5e1eda9d33de](https://github.com/notadragon/gnu_gcc/commit/5e1eda9d33de7f63eaeb09ddac88fcb7b8dd8495))
**Resolved by:** `1220-noexcept-body-wrapper-detected`
...
A `noexcept` function with a contract specifier segfaults the compiler under
...
`gcc/testsuite/g++.dg/contracts/cpp26/pr127173.C` (added by [5e1eda9d33de](https://github.com/notadragon/gnu_gcc/commit/5e1eda9d33de7f63eaeb09ddac88fcb7b8dd8495)).
...
`gcc-16.2.0/bin/g++` and `gcc-trunk/bin/g++`
