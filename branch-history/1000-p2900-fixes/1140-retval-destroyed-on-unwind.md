...
subject: 'c++: contracts: P2900: one return-value cleanup, covering the postcondition checks'
...
- gcc/cp/contracts.cc : #56:1, #72:1, #80, /^postconditions_may_throw_p \(tree fndecl\)$/, /^  const bool unified_retval_cleanup$/, /Hand the splice back to do_poplevel/, @wrap_postconditions_in_retval_cleanup
