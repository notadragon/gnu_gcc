...
// definition).  This shape also crosses an unrelated hazard -- a deduced
// return type on an out-of-line definition with a contract -- which
// has its own dedicated regression test in
// dcl.contract.res-auto-return-parm.C.
